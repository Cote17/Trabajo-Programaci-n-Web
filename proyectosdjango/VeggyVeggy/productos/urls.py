...
from .views import eliminar_producto, home, contactanos, inisiarsesion, articulos, trabajaconnosotros, cerrar_sesion, registro, agregar_producto, modificar_producto, updateItem, tiendita, carrito, pago, Dpago, historialPed, seguimiento, cambioestado, cambio
from django.conf import settings
...
urlpatterns = [
    ...
    path('historialPed/', historialPed, name="historialPed"),
